...
//           {/* nav links container */}
//           <div
//             className={`flex md:py-0 py-20 md:px-0 px-5 md:flex-row md:static md:h-auto md:justify-center justify-around md:w-auto w-70  h-[100vh] fixed left-0 top-[0rem] flex-col items-center bg-white transition-all duration-200 ease-in ${isNavActive ? "left-[0rem]" : "left-[-50rem]"
//               }`}
//           >
//             <div className="flex justify-center items-center md:hidden p-2">
//               <NavLink to="/">
...
//                       <NavLink
//                         className={({ isActive }) =>
//                           `group flex p-3 md:justify-center items-center md:mx-0 font-semibold hover:text-orange-color lg:text-[15px] md:text-[11px] text-[15px] ${isActive ? "text-orange-color" : ""
//                           }`
//                         }

//                         // to={NavVal.path}
//                         to={`/${NavVal.label.toLowerCase().replace(/\s+/g, "-")}`}
...
//                     {hasDropdown && (
//                       <ul
//                         className={`flex flex-col bg-white transition-all duration-300 overflow-hidden md:absolute md:top-10 md:left-0 md:min-w-max md:shadow-lg md:rounded-md md:opacity-0 md:invisible md:group-hover:opacity-100 md:group-hover:visible ${isOpen ? "max-h-[500px] py-2 px-4" : "max-h-0"} md:max-h-max md:py-2 md:px-5 w-full`}
//                       >
//                         {NavVal.dropdown.map((drop, idx) => (
//                           <li key={idx} className="my-2 ps-1">
//                             <NavLink
//                               to={`/${drop.label.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")}`}
//                               className={({ isActive }) => `text-gray-400 font-medium hover:ml-2 hover:text-orange-color transition-all duration-300 lg:text-[1rem] text-[.9rem] ${isActive ? "text-orange-color" : ""}`}
//                               onClick={() => {
//                                 IsNavBtnActive();
//                                 setOpenDropdownIndex(null);
